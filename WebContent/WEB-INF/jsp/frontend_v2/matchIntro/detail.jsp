			...
			<div class="col-sm-12 col-xs-12">
				<div>
					<div class="large_title_01">
						<i class="fa fa-calendar-check-o" aria-hidden="true" style="font-size: 18px; margin-right: 5px;"></i>媒合專區
					</div>
...
<%-- 				<s:include value="./left_menu.jsp" /> --%>
			...
			<div class="col-sm-9 col-xs-12 bottom20">
				<div class="large_title_03">產學媒合服務團簡介</div>
				...
				<div class="content_01 ">
					<s:include value="./detail-content.jsp" />
				</div>
			</div>
		</div>
	</div>	
