		...
		<div class="row">
			...
			<div class="col-sm-9 col-xs-12">
				...
				<div class="content_01 top10 text-center">
					如果您想修改個人資料，只要直接修改相關欄位，按下確定送出即可。(<span style="color: #F00;"> * </span>為必填)
				</div>
				<div class="content_01 well top10">
					<s:form action="selfUpdateSubmit" method="post" validate="true" class="form-horizontal" onsubmit="return validateForm()">
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<s:textfield name="member.account" disabled="true" class="form-control" />
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<s:textfield name="member.email" disabled="true" class="form-control" />
