...
<script type="text/javascript">
	$(document).ready(function () {	
		var pageIndex = parseInt('<s:property value="enterpriseRequireTechPagedList.pageIndex"/>');
		var pageNumber = parseInt('<s:property value="enterpriseRequireTechPagedList.pageNumber"/>');
		var pageCount = parseInt('<s:property value="enterpriseRequireTechPagedList.pageCount"/>');
...
<div class="col-sm-12 col-xs-12 pagination">
	...
	<s:set var="pgList" value="enterpriseRequireTechPagedList"/>
