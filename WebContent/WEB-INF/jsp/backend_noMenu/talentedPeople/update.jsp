...
<body>
	<s:form namespace="/f/talentedPeople" action="selfUpdateSubmit" method="post" validate="true" enctype="multipart/form-data" id="form-update">
		<div>
...
<!----------------------------------------------------------------------------->
		...
		<div id="div-rdResult">
			<div>
				...
				<s:url value="/f/talentedPeopleRdResult/create" var="createUrlTag" escapeAmp="false">
			...
			<table id="table-rdResult">
				...
				<tbody>
					...
					<tr>
						...
						<td>
							<!-- 編輯 -->
							<s:url value="/f/talentedPeopleRdResult/selfUpdate" var="updateUrlTag" escapeAmp="false">
								<s:param name="talentedPeopleId" value="talentedPeople.id" />
							...
							<!-- 刪除 -->
							<s:url value="/f/talentedPeopleRdResult/selfDeleteSubmit" var="deleteUrlTag" escapeAmp="false">
								<s:param name="id" value="id" />
								<s:param name="scrollTo" value="%{'#div-rdResult'}"/>
							</s:url>
...
<!----------------------------------------------------------------------------->
		<div id="div-transferCase">
			<div>
				<b>成果移轉及授權案例</b>
				<s:url value="/f/talentedPeopleTransferCase/create" var="createUrlTag" escapeAmp="false">
					<s:param name="talentedPeopleId" value="talentedPeople.id" />
			...
			<table id="table-transferCase">
				...
				<tbody>
					...
					<tr>
						...
						<td>
							<!-- 編輯 -->
							<s:url value="/f/talentedPeopleTransferCase/selfUpdate" var="updateUrlTag" escapeAmp="false">
								<s:param name="talentedPeopleId" value="talentedPeople.id" />
								<s:param name="id" value="id" />
								<s:param name="scrollTo" value="%{'#div-transferCase'}"/>
							</s:url>
							...
							<!-- 刪除 -->
							<s:url value="/f/talentedPeopleTransferCase/selfDeleteSubmit" var="deleteUrlTag" escapeAmp="false">
								<s:param name="id" value="id" />
								<s:param name="scrollTo" value="%{'#div-transferCase'}"/>
							</s:url>
							<s:hidden value="%{#deleteUrlTag}" class="deleteUrl" disabled="true"/>
...
<!----------------------------------------------------------------------------->
		...
		<div id="div-mainProject">
			<b>主要產學合作計畫案例</b>
			<s:url value="/f/talentedPeopleMainProject/create" var="createUrlTag" escapeAmp="false">
				<s:param name="talentedPeopleId" value="talentedPeople.id" />
			...
			<table id="table-mainProject">
				...
				<tbody>
					...
					<tr>
						...
						<td>
							<!-- 編輯 -->
							<s:url value="/f/talentedPeopleMainProject/selfUpdate" var="updateUrlTag" escapeAmp="false">
								<s:param name="talentedPeopleId" value="talentedPeople.id" />
								<s:param name="id" value="id" />
								<s:param name="scrollTo" value="%{'#div-mainProject'}"/>
							</s:url>
							...
							<!-- 刪除 -->
							<s:url value="/f/talentedPeopleMainProject/selfDeleteSubmit" var="deleteUrlTag" escapeAmp="false">
								<s:param name="id" value="id" />
								<s:param name="scrollTo" value="%{'#div-mainProject'}"/>
							</s:url>
							<s:hidden value="%{#deleteUrlTag}" class="deleteUrl" disabled="true"/>
