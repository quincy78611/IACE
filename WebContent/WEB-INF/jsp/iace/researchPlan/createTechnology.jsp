...
<%-- 			<s:hidden name="technology.researchPlan.id" /> --%>
			...
			<s:select label="技術發展階段" name="technology.trl.code" list="optionTrlList" listKey="code" listValue="%{code +' ' +name}" headerKey="" headerValue="" />			
