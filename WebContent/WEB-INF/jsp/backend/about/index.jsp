...
<script>	
	function paggingSetting() {
		...
		var pageIndex = parseInt('<s:property value="aboutPagedList.pageIndex"/>');
		var pageNumber = parseInt('<s:property value="aboutPagedList.pageNumber"/>');
		var pageCount = parseInt('<s:property value="aboutPagedList.pageCount"/>');
...
<!-- 	<h2 class="itemTitle">編輯管理</h2> -->
	<s:form action="index" method="post" validate="true" >
		...
		<div class="page">
			<s:set var="pgList" value="aboutPagedList"/>
		...
		<div class="">
			<table class="table table-striped table-hover table-bordered">
				...
				<tbody>
					<s:if test="aboutPagedList != null">
						<s:iterator value="aboutPagedList.list" status="stat">
							<tr>
								<td>
									<s:property value="%{aboutPagedList.itemStart + #stat.count -1}" />
									<%-- <s:property value="id" /> --%>
								</td>						
