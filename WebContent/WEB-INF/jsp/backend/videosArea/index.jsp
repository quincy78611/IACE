...
<script>	
	function paggingSetting() {
		...
		var pageIndex = parseInt('<s:property value="videosAreaPagedList.pageIndex"/>');
		var pageNumber = parseInt('<s:property value="videosAreaPagedList.pageNumber"/>');
		var pageCount = parseInt('<s:property value="videosAreaPagedList.pageCount"/>');
...
<body>
	<s:form action="index" method="post" validate="true" >
		<div class="page">
			<s:set var="pgList" value="videosAreaPagedList"/>
				...
				<tbody>
					<s:if test="videosAreaPagedList != null">
						<s:iterator value="videosAreaPagedList.list" status="stat">
							<tr>
								<td>
									<s:property value="%{videosAreaPagedList.itemStart + #stat.count -1}" />
								</td>
