        ...
        <div class="row no-gutter">
            ...
            <div class="col-sm-5 col-xs-12 nopadding footer_content text-right">
                <ul class="list-inline footer_content_02">
                	<li><a href="#" class="footer_link">網站地圖</a></li><li>│</li><li><a href="#" class="footer_link">客服信箱</a></li><li>│</li><li><a href="#" class="footer_link">聯絡電話</a></li><li>│</li><li><a href="#" class="footer_link">隱私權宣告</a></li><li>│</li><li><a href="#" class="footer_link">版權宣告</a></li><li>│</li><li><a href="#" class="footer_link">圖片授權宣告</a></li>
                </ul>
            </div>
        </div>
    </div>
