        ...
        <div class="row">
        	<div class="col-sm-2 col-xs-6">
                ...
                <ul class="small_title_02">
                	<li><a href="#" class="list_link_04">成果發表</a></li>
                    <li><a href="#" class="list_link_04">計畫宣導</a></li>
                    <li><a href="#" class="list_link_04">媒合會</a></li>
                    <li><a href="#" class="list_link_04">人培課程</a></li>
                    <li><a href="#" class="list_link_04">外部活動</a></li>
                    <li><a href="#" class="list_link_04">計畫研習</a></li>
                </ul>
            </div>
            <div class="col-sm-2 col-xs-6">
