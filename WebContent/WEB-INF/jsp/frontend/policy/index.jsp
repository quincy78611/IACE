...
<div class="rightContent frontend">
	<s:form action="index" method="post" validate="true" >
		<s:hidden name="searchCondition.category" value="法規政策"/>
		<div class="">
			<ul>
				<li class="all">
					<s:textfield placeholder="題名" name="searchCondition.searchText" />
				</li>
			</ul>
		</div>
				...
				<s:if test="literaturePagedList != null">
					<s:iterator value="literaturePagedList.list" status="stat">
						<tr>
							...
							<td>
<%-- 								<s:url value="/f/policy/showDetail" var="detailUrlTag" escapeAmp="false"> --%>
...
<!-- 									<br> -->
<%-- 									<s:property value="titleF" /> --%>
<!-- 								</a> -->
								
								<a href="<s:property value="linkUrl"/>" target="_blank">
									<s:property value="titleC" />
									<br>
									<s:property value="titleF" />
								</a>
