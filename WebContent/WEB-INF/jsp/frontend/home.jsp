...
<body>
	<div id="item01">
    	<h3 class="intro">
    		重點研發成果推介
    		<a href="<s:url value="/f/researchPlan/init"/>" class="more"></a>
    	</h3>
        <div class="item01-L">
	        ...
	        <ul>
		        <s:iterator value="coopExList" status="stat">
		        	<li>
		        		...
		        		<a href="<s:property value="#urlTag" />">
		        			<img src="data:image;base64,<s:property value="imgs[0].base64Img"/>" style="max-width:180px; max-height:100px; "/>
		        			<br>
